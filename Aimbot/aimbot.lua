...
function Environment.Exit(self) -- METHOD | Aimbot:Exit(<void>)
	assert(self, "AIMBOT-V3.Exit: Missing parameter #1 \"self\" <table>.")
...
function Environment.Blacklist(self, Username) -- METHOD | Aimbot:Blacklist(<string> Player Name)
	assert(self, "AIMBOT-V3.Blacklist: Missing parameter #1 \"self\" <table>.")
	assert(Username, "AIMBOT-V3.Blacklist: Missing parameter #2 \"Username\" <string>.")
 
	Username = FixUsername(Username)
 
	assert(self, "AIMBOT-V3.Blacklist: User "..Username.." couldn't be found.")
 
	self.Blacklisted[#self.Blacklisted + 1] = Username
end

function Environment.Whitelist(self, Username) -- METHOD | Aimbot:Whitelist(<string> Player Name)
	assert(self, "AIMBOT-V3.Whitelist: Missing parameter #1 \"self\" <table>.")
	assert(Username, "AIMBOT-V3.Whitelist: Missing parameter #2 \"Username\" <string>.")
 
	Username = FixUsername(Username)
 
	assert(Username, "AIMBOT-V3.Whitelist: User "..Username.." couldn't be found.")
 
	local Index = tablefind(self.Blacklisted, Username)
 
	assert(Index, "AIMBOT-V3.Whitelist: User "..Username.." is not blacklisted.")
